      ...
      <section className="mx-auto max-w-6xl px-5 py-14 md:py-20">
        <div className="relative mx-auto flex max-w-4xl flex-col items-center justify-center rounded-3xl px-10 py-14 text-white">
          ...
          <p className="mt-6 w-8/12 text-center">
            ...
            delivered right to your inbox with our chocolate and cake shop
            newsletter.
          </p>
          <div className="relative mt-6 w-[400px]">
            ...
            <Button
              variant="secondary"
              className="text-brown-900 absolute right-0 top-1/2 mr-1 h-8 -translate-y-1/2 transform bg-white hover:bg-white"
              size="sm"
            >
              Subscribe
            </Button>
